...
const envSchema = z.object({
  APP_NAME: z.string().default("RiDDiX Invite Portal"),
  ...
  SYNAPSE_INTERNAL_URL: z.string().url(),
  SYNAPSE_PUBLIC_URL: z.string().url(),
  SYNAPSE_SERVER_NAME: z.string().min(1),
  SYNAPSE_ADMIN_ACCESS_TOKEN: z.string().min(1),
